...
const conn = mysql.createConnection({
  ...
  password: 'GenshinImpact1', /* MySQL Password */
  database: 'sharkdb' /* MySQL Database */
});
 ...
 * @return response()
 */
app.post('/api/allReceivers/', (req, res) => {
  let sqlQuery = "CALL allReceivers('" + req.body.town_param + "', '" + req.body.state_param + "')";
  // let sqlQuery = "CALL allReceivers('" + req.params.town_param + "', '" + req.params.state_param + "');";
